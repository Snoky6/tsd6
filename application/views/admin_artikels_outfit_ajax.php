    ...
    <?php if ($counter == 0) { ?> <div class="row"> <?php } ?>
        <div class="4u">						
            ...
            <section class="box feature"> 
                ...
                <?php } ?>
                <?php echo '<a href="javascript:void(0)" class="image featured shopimg" onClick="voegArtikelToeAanOutfit(' . $artikel->id . ')"><img src="' . base_url() . APPPATH . $artikel->imagePath . '" alt="" /></a>'; ?>
                <div class="inner">
                    <header>
